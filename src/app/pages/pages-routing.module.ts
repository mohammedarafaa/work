    ...
    children: [
     ...
     // for customer
      ...
      { path: 'Customer' ,children: [
        ...
        { path: 'Update_Customer/:CustomerId', component: CustomerFormComponent },
      ...
      { path: 'Property' ,children: [
        ...
        { path: 'Update_Property/:PropertyId', component: PropertyFormComponent },
        
      ]},
      { path: 'Project' ,children: [
        { path: '', component: ProjectComponent },
        { path: 'Create_Project', component: ProjectFormComponent },
        { path: 'Update_Project/:ProjectId', component: ProjectFormComponent },
        
      ]},
      { path: 'Payment_Getway' ,children: [
        { path: '', component: PaymentGetwayComponent },
        { path: 'Create_Payment_Getway', component: PaymentGetwayFormComponent },
        { path: 'Update_Payment_Getway/:PaymentGetwayId', component: PaymentGetwayFormComponent },
